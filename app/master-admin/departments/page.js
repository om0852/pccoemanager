...
export default function DepartmentManagement() {
  ...
  }, [user, loading, router, isMasterAdmin]);
      ...
      <div className="sm:flex sm:items-center sm:justify-between mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Manage all departments in the college
          </p>
        </div>
        <div className="mt-4 sm:mt-0">
          <Link href="/master-admin/departments/new" className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            Add Department
          </Link>
        </div>
      </div>
              ...
              <li key={department._id}>
                <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    <Link
                      href={`/master-admin/departments/edit/${department._id}`}
