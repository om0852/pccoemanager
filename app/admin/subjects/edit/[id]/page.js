...
export default function EditSubjectPage({ params }) {
  ...
  // Load subject data when component mounts
  useEffect(() => {
    if (user && isAdmin() && id) {
      fetchSubject();
      fetchDepartments();
  ...
  const fetchSubject = async () => {
    try {
      ...
      setFormError('Failed to load subject. Please try again later.');
    } finally {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow overflow-hidden sm:rounded-lg p-6 text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">Subject Not Found</h3>
          <p className="mt-2 text-sm text-gray-600">The subject you are looking for does not exist or you do not have permission to edit it.</p>
          <div className="mt-6">
            <Link 
              href="/admin/subjects"
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">Loading subject information...</p>
          </div>
          <Link
            href="/admin/subjects"
