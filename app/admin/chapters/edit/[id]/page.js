...
export default function EditChapterPage({ params }) {
  ...
  const fetchChapter = async () => {
    try {
      ...
      setFormData({
        ...
        learningOutcomes: chapter.learningOutcomes && chapter.learningOutcomes.length > 0 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/admin/chapters?subject=${subject._id}`);
      }, 1500);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href={`/admin/chapters?subject=${subject?._id}`}
